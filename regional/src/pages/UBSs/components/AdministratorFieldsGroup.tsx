...
import type { UBSAdministratorFormData } from '../../../types/ubs';
...
interface AdministratorFieldsGroupProps {
  index: number;
  data: UBSAdministratorFormData;
  errors?: AdministratorFieldErrors;
  onChange: (field: keyof UBSAdministratorFormData, value: string) => void;
 ...
 *
 * Mesmo padrão de AdministratorFieldsGroup.tsx de Clínicas Privadas,
 * adaptado para UBS (sem cargo/nível de acesso — o portal é do próprio
