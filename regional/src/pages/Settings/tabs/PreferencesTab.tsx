...
function PreferencesTab() {
  const [darkMode, setDarkMode] = useLocalStorage('vacmais-regional:darkMode', false);
  const [brightness, setBrightness] = useLocalStorage('vacmais-regional:brightness', 100);
  const [audioDescription, setAudioDescription] = useLocalStorage(
    'vacmais-regional:audioDescription',
    false,
  );
